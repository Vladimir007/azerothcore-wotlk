#ifndef DBC_DEFINES_H
#define DBC_DEFINES_H
...
#define MAX_PET_TALENT_RANK 3  // Used in calculations, expected <= MAX_TALENT_RANK
...
enum AchievementFlags
{
    ...
    ACHIEVEMENT_FLAG_AVERAGE           = 0x00000040,  // Show as average value (value / time_in_days); depends on other flag (by def use last criteria value)
    ACHIEVEMENT_FLAG_BAR               = 0x00000080,  // Show as progress bar (value / max vale); depends on other flag (by def use last criteria value)
...
enum AchievementCriteriaTypes
{
    ...
    ACHIEVEMENT_CRITERIA_TYPE_WIN_RATED_ARENA               = 37, /// @todo: the achievements 1162 and 1163 requires a special rating which can't be found in the dbc
    ...
    ACHIEVEMENT_CRITERIA_TYPE_VISIT_BARBER_SHOP             = 48, // Note: rewarded as soon as the player paid, not at taking place at the seat
...
enum AreaFlags
{
    ...
    AREA_FLAG_LOW_LEVEL          = 0x00100000,  // Used for some starting areas with area_level <= 15
    ...
    AREA_FLAG_INSIDE             = 0x02000000,  // Used for determination spell related inside/outside questions in Map::IsOutdoors
    AREA_FLAG_OUTSIDE            = 0x04000000,  // Used for determination spell related inside/outside questions in Map::IsOutdoors
...
enum ChrRacesFlags
{
    CHR_RACES_FLAGS_NOT_PLAYABLE = 0x01,
    CHR_RACES_FLAGS_BARE_FEET    = 0x02,
    CHR_RACES_FLAGS_CAN_MOUNT    = 0x04
};
...
enum SpawnMask
{
    SPAWN_MASK_CONTINENT         = 1 << REGULAR_DIFFICULTY, // Any maps without spawn modes

    SPAWN_MASK_DUNGEON_NORMAL    = 1 << DUNGEON_DIFFICULTY_NORMAL,
    SPAWN_MASK_DUNGEON_HEROIC    = 1 << DUNGEON_DIFFICULTY_HEROIC,
    SPAWN_MASK_DUNGEON_ALL       = SPAWN_MASK_DUNGEON_NORMAL | SPAWN_MASK_DUNGEON_HEROIC,

    SPAWN_MASK_RAID_10MAN_NORMAL = 1 << RAID_DIFFICULTY_10MAN_NORMAL,
    SPAWN_MASK_RAID_25MAN_NORMAL = 1 << RAID_DIFFICULTY_25MAN_NORMAL,
    SPAWN_MASK_RAID_NORMAL_ALL   = SPAWN_MASK_RAID_10MAN_NORMAL | SPAWN_MASK_RAID_25MAN_NORMAL,

    SPAWN_MASK_RAID_10MAN_HEROIC = 1 << RAID_DIFFICULTY_10MAN_HEROIC,
    SPAWN_MASK_RAID_25MAN_HEROIC = 1 << RAID_DIFFICULTY_25MAN_HEROIC,
    SPAWN_MASK_RAID_HEROIC_ALL   = SPAWN_MASK_RAID_10MAN_HEROIC | SPAWN_MASK_RAID_25MAN_HEROIC,

    SPAWN_MASK_RAID_ALL          = SPAWN_MASK_RAID_NORMAL_ALL | SPAWN_MASK_RAID_HEROIC_ALL,
};
...
{
    SKILL_FLAG_NO_SKILL_UP_MESSAGE  = 0x2,
...
enum VehicleSeatFlags
{
    ...
    VEHICLE_SEAT_FLAG_HAS_START_WRITING_FOR_VEH_TRANSITION_ANIM_ENTER  = 0x08000000,
    VEHICLE_SEAT_FLAG_HAS_START_WRITING_FOR_VEH_TRANSITION_ANIM_EXIT   = 0x10000000,
...
enum VehicleSeatFlagsB
{
    ...
    VEHICLE_SEAT_FLAG_B_TARGETS_IN_RAID_UI       = 0x00000008,  // Lua_UnitTargetsVehicleInRaidUI
    ...
    VEHICLE_SEAT_FLAG_B_VEHICLE_PLAYER_FRAME_UI  = 0x80000000,  // Lua_UnitHasVehiclePlayerFrameUI - actually checked for FlagsB &~ 0x80000000
};
