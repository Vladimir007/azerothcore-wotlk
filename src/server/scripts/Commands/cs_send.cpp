...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        {
            { "items",   HandleSendItemsCommand,   SuperuserOnly::No },
            { "mail",    HandleSendMailCommand,    SuperuserOnly::No },
            { "message", HandleSendMessageCommand, SuperuserOnly::Yes },
            { "money",   HandleSendMoneyCommand,   SuperuserOnly::No }
        };
