...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        {
            { "attributes", HandleSpellInfoAttributesCommand, SuperuserOnly::No },
            { "effects",    HandleSpellInfoEffectsCommand,    SuperuserOnly::No },
            { "targets",    HandleSpellInfoTargetsCommand,    SuperuserOnly::No },
            { "all",        HandleSpellInfoAllCommand,        SuperuserOnly::No }
        };
    ...
    static void PrintBasicInfo(ChatHandler* handler, SpellInfo const* spell)
    {
        ...
        handler->PSendSysMessage("Name: {}", spell->SpellName);
        if (!spell->Rank.empty() && spell->Rank[0] != '\0')
            handler->PSendSysMessage("Rank: {}", spell->Rank);
