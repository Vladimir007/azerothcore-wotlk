...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        {
            { "create",  HandlePetCreateCommand,  SuperuserOnly::No  },
            { "delete",  HandlePetDeleteCommand,  SuperuserOnly::No },
            { "learn",   HandlePetLearnCommand,   SuperuserOnly::No  },
            { "list",    HandlePetListCommand,    SuperuserOnly::No },
            { "rename",  HandlePetRenameCommand,  SuperuserOnly::No },
            { "unlearn", HandlePetUnlearnCommand, SuperuserOnly::No  }
        };
