...
#define CHARACTERS_PER_REALM 10
#define CHARACTERS_PER_ACCOUNT 50
#define HEROIC_CHARACTERS_PER_REALM 2

constexpr uint32 CLIENT_CACHE_VERSION = 16;
constexpr uint32 StartPlayerLevel = 1;
constexpr uint32 StartHeroicPlayerLevel = 55;
constexpr uint32 StartPlayerMoney = 0;
constexpr uint32 StartHeroicPlayerMoney = 2000;  // 20 silver
...
enum ServerConfigs
{
    ...
    CONFIG_VMAP_BLIZZ_LIKE_PVP_LOS,
    CONFIG_VMAP_BLIZZ_LIKE_LOS_OPEN_WORLD,
