...
enum NPCFlags : uint32
{
    ...
    UNIT_NPC_FLAG_QUEST_GIVER               = 0x00000002,       // TITLE is quest giver DESCRIPTION guessed, probably ok
    ...
    UNIT_NPC_FLAG_FLIGHT_MASTER             = 0x00002000,       // TITLE is flight master DESCRIPTION 100%
    UNIT_NPC_FLAG_SPIRIT_HEALER             = 0x00004000,       // TITLE is spirit healer DESCRIPTION guessed
    UNIT_NPC_FLAG_SPIRIT_GUIDE              = 0x00008000,       // TITLE is spirit guide DESCRIPTION guessed
    ...
    UNIT_NPC_FLAG_TABARD_DESIGNER           = 0x00080000,       // TITLE is guild tabard designer DESCRIPTION 100%
    ...
    UNIT_NPC_FLAG_SPELL_CLICK                = 0x01000000,       // TITLE has spell click enabled DESCRIPTION cause client to send 1015 opcode (spell click)
